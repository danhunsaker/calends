...
class CalendsCreateDoubleStartPeriodOptimizer extends OptimizerAbstract
{
    public function optimize(array $expression, Call $call, CompilationContext $context)
    {
        if (count($expression['parameters']) != 4) {
            throw new CompilerException("'Calends_create_double_start_period' only accepts 4 parameters", $expression);
        }
