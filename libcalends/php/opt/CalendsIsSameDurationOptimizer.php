...
class CalendsIsSameDurationOptimizer extends OptimizerAbstract
{
    public function optimize(array $expression, Call $call, CompilationContext $context)
    {
        if (count($expression['parameters']) != 2) {
            throw new CompilerException("'Calends_is_same_duration' only accepts 2 parameters", $expression);
        }
