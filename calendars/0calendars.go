// The calendars package provides the underlying framework that makes Calends
...
var (
	UnknownCalendarError  = errors.New("Unknown Calendar")
	UnsupportedInputError = errors.New("Unsupported Value")
