...
func TestGregorianToInternal(t *testing.T) {
	cases := []map[string][]interface{}{
		{"in": []interface{}{"Thu, 01 Jan 1970 00:00:01 UTC", ""}, "want": []interface{}{TAI64NAXURTime{Seconds: 1}, nil}},
		{"in": []interface{}{"1970-01-01 00:00:01 UTC", "2006-01-02 15:04:05 MST"}, "want": []interface{}{TAI64NAXURTime{Seconds: 1}, nil}},
		{"in": []interface{}{"1970-01-01 00:00:01 UTC", "%Y-%m-%d %H:%M:%S %Z"}, "want": []interface{}{TAI64NAXURTime{Seconds: 1}, nil}},
		{"in": []interface{}{[]byte("Thu, 01 Jan 1970 00:00:01 UTC"), ""}, "want": []interface{}{TAI64NAXURTime{Seconds: 1}, nil}},
		{"in": []interface{}{time.Unix(1, 0), ""}, "want": []interface{}{TAI64NAXURTime{Seconds: 1}, nil}},
